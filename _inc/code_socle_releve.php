      ...
      if( ($make_officiel) && ($_SESSION['OFFICIEL']['SOCLE_APPRECIATION_GENERALE']) )
      {
        if($make_html)
        {
          ...
          if(isset($tab_saisie[$eleve_id][0]))
          {
            ...
            $releve_HTML .= '<tr id="appr_0_'.$prof_id.'">'.$case_score.'<td colspan="2" class="now"><div class="notnow">'.html($prof_info).$actions.'</div><div class="appreciation">'.html($appreciation).'</div></td>'.$case_valid.'</tr>'."\r\n";
          }
