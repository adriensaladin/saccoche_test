...
$tab_connexion_info['cas'][ '31|kosmos_ecollege31']          = array( 'txt'=>'ENT eCollège 31 (académie de Toulouse).'                      , 'etat'=>1 , 'societe'=>'Kosmos'             ) + $tab_csv_format['kosmos']      + $tab_serveur_cas['kosmos_ecollege31'];
...
$tab_connexion_info['cas'][ '76|logica_arsene76']            = array( 'txt'=>'ENT Arsene 76 (département de Seine-Maritime).'               , 'etat'=>1 , 'societe'=>'Logica'             ) + $tab_csv_format['logica']      + $tab_serveur_cas['logica_arsene76'];
