...
$tab_connexion_info['cas'][ '67|itop_alsace']                = array( 'txt'=>'ENT Alsace (académie de Strasbourg).'                         , 'etat'=>1 , 'societe'=>'Infostance'         ) + $tab_csv_format['scolastance'] + $tab_serveur_cas['itop_alsace'];
$tab_connexion_info['cas'][ '68|itop_alsace']                = array( 'txt'=>'ENT Alsace (académie de Strasbourg).'                         , 'etat'=>1 , 'societe'=>'Infostance'         ) + $tab_csv_format['scolastance'] + $tab_serveur_cas['itop_alsace'];
