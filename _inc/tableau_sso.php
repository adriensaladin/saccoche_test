...
$tab_connexion_info['cas']['ent_38']           = array( 'etat'=>0 , 'societe'=>'iTop'               , 'serveur_host'=>'cas.enteduc.fr'          , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT de l'Isère (38)." );
...
$tab_connexion_info['cas']['liberscol']        = array( 'etat'=>0 , 'societe'=>'Tetra Informatique' , 'serveur_host'=>'cas.ent-liberscol.fr'    , 'serveur_port'=>443  , 'serveur_root'=>''               , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>0 , 'csv_prenom'=>1 , 'csv_id_ent'=>2 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Liberscol (académie de Dijon)." );
...
$tab_connexion_info['cas']['mirabelle']        = array( 'etat'=>0 , 'societe'=>'iTop'               , 'serveur_host'=>'cas.enteduc.fr'          , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Mirabelle (académie de Nancy-Metz)." ); // Mirabelle va migrer sur le serveur CAS de Place. [Geoffrey JOGUET 26/03/2012]
$tab_connexion_info['cas']['ent_06']           = array( 'etat'=>0 , 'societe'=>'iTop'               , 'serveur_host'=>'cas.enteduc.fr'          , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT de Nice (06)." ); // Nice va posséder son propre serveur CAS [Geoffrey JOGUET 26/03/2012]
$tab_connexion_info['cas']['ent_60']           = array( 'etat'=>0 , 'societe'=>'iTop'               , 'serveur_host'=>'ent.oise.fr'             , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT de l'Oise (60)." ); // L'Oise ne possède pas encore de serveur CAS étant chez un intégrateur [Geoffrey JOGUET 26/03/2012]
$tab_connexion_info['cas']['place']            = array( 'etat'=>0 , 'societe'=>'iTop'               , 'serveur_host'=>'www.placedulycee.fr'     , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Place (Lorraine - 54 55)." );
...
$tab_connexion_info['cas']['ent_80']           = array( 'etat'=>0 , 'societe'=>'iTop'               , 'serveur_host'=>'cas.enteduc.fr'          , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT de la Somme (80)." );
