...
CREATE TABLE sacoche_livret_page (
  ...
  livret_page_rubrique_join  VARCHAR(7)                        COLLATE utf8_unicode_ci NOT NULL DEFAULT "" COMMENT "Modifiable, pour indiquer le type de jointure à utiliser (matiere | domaine | theme | item).",
  livret_page_colonne_defaut VARCHAR(8)                        COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
  livret_page_colonne_choix  VARCHAR(11)                       COLLATE utf8_unicode_ci NOT NULL DEFAULT "" COMMENT "Modifiable pour le collège (moyenne | pourcentage | position).",
...
("6e",     33, "Niveau 6e"        , "Classe de 6e" , "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "matiere", "matiere", "moyenne" , ""        , 0, 1, "P_AVN,P_CIT,P_ART,P_SAN", 1),
...
("5e",     41, "Niveau 5e"        , "Classe de 5e" , "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "matiere", "matiere", "moyenne" , ""        , 1, 1, "P_AVN,P_CIT,P_ART,P_SAN", 1),
("4e",     42, "Niveau 4e"        , "Classe de 4e" , "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "matiere", "matiere", "moyenne" , ""        , 1, 1, "P_AVN,P_CIT,P_ART,P_SAN", 1),
("3e",     43, "Niveau 3e"        , "Classe de 3e" , "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "matiere", "matiere", "moyenne" , ""        , 1, 1, "P_AVN,P_CIT,P_ART,P_SAN", 1),
