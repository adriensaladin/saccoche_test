...
("cp",     21, "Niveau CP"        , "Classe de CP" , "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "c2_domaine", "domaine", "objectif", 0, 0, 0,       "P_CIT,P_ART,P_SAN", 0),
("ce1",    22, "Niveau CE1"       , "Classe de CE1", "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "c2_domaine", "domaine", "objectif", 0, 0, 0,       "P_CIT,P_ART,P_SAN", 0),
("ce2",    23, "Niveau CE2"       , "Classe de CE2", "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "c2_domaine", "domaine", "objectif", 0, 0, 0,       "P_CIT,P_ART,P_SAN", 0),
...
("cm1",    31, "Niveau CM1"       , "Classe de CM1", "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "c3_domaine", "domaine", "objectif", 0, 0, 0,       "P_CIT,P_ART,P_SAN", 0),
("cm2",    32, "Niveau CM2"       , "Classe de CM2", "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "c3_domaine", "domaine", "objectif", 0, 0, 0,       "P_CIT,P_ART,P_SAN", 0),
("6e",     33, "Niveau 6e"        , "Classe de 6e" , "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "c3_matiere", "matiere", "moyenne" , 1, 0, 1, "P_AVN,P_CIT,P_ART,P_SAN", 1),
...
("5e",     41, "Niveau 5e"        , "Classe de 5e" , "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "c4_matiere", "matiere", "moyenne" , 1, 1, 1, "P_AVN,P_CIT,P_ART,P_SAN", 1),
("4e",     42, "Niveau 4e"        , "Classe de 4e" , "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "c4_matiere", "matiere", "moyenne" , 1, 1, 1, "P_AVN,P_CIT,P_ART,P_SAN", 1),
("3e",     43, "Niveau 3e"        , "Classe de 3e" , "Suivi des acquis scolaires - Bilan de l'acquisition des connaissances et compétences", "periode", "c4_matiere", "matiere", "moyenne" , 1, 1, 1, "P_AVN,P_CIT,P_ART,P_SAN", 1),
