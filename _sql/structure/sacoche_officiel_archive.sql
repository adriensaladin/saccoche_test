...
CREATE TABLE sacoche_officiel_archive (
  ...
  archive_type                     ENUM("sacoche","lsun") COLLATE utf8_unicode_ci NOT NULL DEFAULT "sacoche",
  archive_ref                      VARCHAR(9)             COLLATE utf8_unicode_ci NOT NULL DEFAULT ""   COMMENT "Valeur de lsun_page_ref ou de officiel_type.",
