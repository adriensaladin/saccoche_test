...
CREATE TABLE sacoche_officiel_saisie (
  ...
  eleve_id            MEDIUMINT(8)                                            UNSIGNED                NOT NULL DEFAULT 0    COMMENT "0 pour l'appréciation sur la classe",
  rubrique_id         SMALLINT(5)                                             UNSIGNED                NOT NULL DEFAULT 0    COMMENT "matiere_id ou pilier_id ; 0 pour l'appréciation générale ou sur la classe",
