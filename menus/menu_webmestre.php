...
(
  ...
  'gestion_mono'  => "Établissement", // mono-structure uniquement
);
...
(
  ...
  'gestion_mono' => array
  (
    'webmestre_mdp_admin'     => array( 'texte' => "Mot de passe administrateur" , 'class' => 'mdp_admin'    , 'href' => 'page=webmestre_mdp_admin'    ),
    'webmestre_statistiques'  => array( 'texte' => "Statistiques d'utilisation"  , 'class' => 'statistiques' , 'href' => 'page=webmestre_statistiques' ),
    'webmestre_resilier'      => array( 'texte' => "Résilier l'inscription"      , 'class' => 'resilier'     , 'href' => 'page=webmestre_resilier'     ),
  ),
);
...
{
  unset(
    $tab_sous_menu['admin_site']['webmestre_contact_modification'] ,
    $tab_sous_menu['admin_site']['webmestre_geographie'] ,
    $tab_sous_menu['admin_site']['webmestre_partenariats'] ,
...
{
  unset( $tab_menu['gestion_mono'] );
  if(!IS_HEBERGEMENT_SESAMATH)
  {
    unset( $tab_sous_menu['admin_site']['webmestre_partenariats'] );
  }
}
