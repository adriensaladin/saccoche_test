...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function afficher_form_gestion( mode , id , id_ent , id_gepi , sconet_id , sconet_num , reference , profil , nom , prenom , birth_date_fr , login , courriel , sortie_date_fr , check )
    {
      ...
      $('#f_login').val(login).parent().css('display','none'); // plutôt que .hide(0) car suite au passage vers jQuery 1.10.2 un hide() sur un élément déjà caché provoque ici sa réapparition...
      $('#box_login').prop('checked',true).next().show(0).html(texte_box);
      // mot de passe
      var texte_box  = (mode=='modifier') ? "inchangé" : "aléatoire" ;
      $('#f_password').val('').parent().css('display','none'); // plutôt que .hide(0) car suite au passage vers jQuery 1.10.2 un hide() sur un élément déjà caché provoque ici sa réapparition...
      $('#box_password').prop('checked',true).next().show(0).html(texte_box);
      // date de naissance
      if(birth_date_fr=='-')
      {
        $('#box_birth_date').prop('checked',true).next().show(0);
        $('#f_birth_date').val('').parent().css('display','none'); // plutôt que .hide(0) car suite au passage vers jQuery 1.10.2 un hide() sur un élément déjà caché provoque ici sa réapparition...
      }
      else
      {
        $('#box_birth_date').prop('checked',false).next().css('display','none'); // plutôt que .hide(0) car suite au passage vers jQuery 1.10.2 un hide() sur un élément déjà caché provoque ici sa réapparition...
      ...
      if(sortie_date_fr=='-')
      {
        ...
        $('#f_sortie_date').val(input_date).parent().css('display','none'); // plutôt que .hide(0) car suite au passage vers jQuery 1.10.2 un hide() sur un élément déjà caché provoque ici sa réapparition...
      }
      else
      {
        $('#box_sortie_date').prop('checked',false).next().css('display','none'); // plutôt que .hide(0) car suite au passage vers jQuery 1.10.2 un hide() sur un élément déjà caché provoque ici sa réapparition...
