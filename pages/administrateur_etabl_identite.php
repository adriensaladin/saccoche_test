...
<div id="div_instance">
  ...
  <form action="#" method="post" id="form_sesamath">
    ...
    <p>
      <label class="tab" for="f_sesamath_id">Identifiant <img alt="" src="./_img/bulle_aide.png" width="16" height="16" title="Valeur non modifiable manuellement.<br />Utiliser le lien ci-dessus." /> :</label><input id="f_sesamath_id" name="f_sesamath_id2" size="5" type="text" value="<?php echo html($_SESSION['SESAMATH_ID']); ?>" readonly /><input name="f_sesamath_id" size="5" type="text" value="<?php echo html($_SESSION['SESAMATH_ID']); ?>" class="invisible" /><br />
      <label class="tab" for="f_sesamath_uai">Code UAI <img alt="" src="./_img/bulle_aide.png" width="16" height="16" title="Valeur non modifiable manuellement.<br />Utiliser le lien ci-dessus." /> :</label><input id="f_sesamath_uai" name="f_sesamath_uai2" size="8" type="text" value="<?php echo html($_SESSION['SESAMATH_UAI']); ?>" readonly /><input name="f_sesamath_uai" size="8" type="text" value="<?php echo html($_SESSION['SESAMATH_UAI']); ?>" class="invisible" /><br />
      <label class="tab" for="f_sesamath_type_nom">Dénomination <img alt="" src="./_img/bulle_aide.png" width="16" height="16" title="Valeur non modifiable manuellement.<br />Utiliser le lien ci-dessus." /> :</label><input id="f_sesamath_type_nom" name="f_sesamath_type_nom2" size="50" type="text" value="<?php echo html($_SESSION['SESAMATH_TYPE_NOM']); ?>" readonly /><input name="f_sesamath_type_nom" size="50" type="text" value="<?php echo html($_SESSION['SESAMATH_TYPE_NOM']); ?>" class="invisible" /><br />
      <label class="tab" for="f_sesamath_key">Clef de contrôle <img alt="" src="./_img/bulle_aide.png" width="16" height="16" title="Valeur non modifiable manuellement.<br />Utiliser le lien ci-dessus." /> :</label><input id="f_sesamath_key" name="f_sesamath_key2" size="35" type="text" value="<?php echo html($_SESSION['SESAMATH_KEY']); ?>" readonly /><input name="f_sesamath_key" size="35" type="text" value="<?php echo html($_SESSION['SESAMATH_KEY']); ?>" class="invisible" /><br />
