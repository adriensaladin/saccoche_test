...
foreach($DB_TAB_NOTE as $DB_ROW_NOTE)
{
  ...
  $tab_notes[] = '<li id="N'.$note_id.'">'
               ...
               .   '<div class="'.$class.'">'
               .     '<div><label class="tab mini" for="note_valeur_'.$note_id.'">valeur :</label><input type="text" size="2" maxlength="3" class="hc" id="note_valeur_'.$note_id.'" name="note_valeur_'.$note_id.'" value="'.$DB_ROW_NOTE['note_valeur'].'" /></div>'
...
foreach($DB_TAB_ACQUIS as $DB_ROW_ACQUIS)
{
  ...
  $tab_acquis[] = '<li id="A'.$acquis_id.'">'
                ...
                .   '<div class="'.$class.'">'
                .     '<div><label class="tab mini">seuils :</label><input type="text" size="2" maxlength="3" class="hc" id="acquis_seuil_'.$acquis_id.'_min" name="acquis_seuil_'.$acquis_id.'_min" value="'.html($DB_ROW_ACQUIS['acquis_seuil_min']).'" /> ~ <input type="text" size="2" maxlength="3" class="hc" id="acquis_seuil_'.$acquis_id.'_max" name="acquis_seuil_'.$acquis_id.'_max" value="'.html($DB_ROW_ACQUIS['acquis_seuil_max']).'" /></div>'
                ...
                .     '<div><label class="tab mini" for="acquis_valeur_'.$acquis_id.'">valeur :</label><input type="text" size="2" maxlength="3" class="hc" id="acquis_valeur_'.$acquis_id.'" name="acquis_valeur_'.$acquis_id.'" value="'.$DB_ROW_ACQUIS['acquis_valeur'].'" /></div>'
                .   '</div>'
                . '</li>';
}
