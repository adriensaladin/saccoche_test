...
$select_releve_modele                  = Form::afficher_select(Form::$tab_select_releve_modele, 'f_releve_modele'                  /*select_nom*/ , FALSE /*option_first*/ , $_SESSION['OFFICIEL']['RELEVE_MODELE']                  /*selection*/ , '' /*optgroup*/);
...
<form action="#" method="post" id="form_releve">
  <p>
    ...
    <label class="tab">Impression :</label><?php echo $select_releve_couleur ?> <?php echo $select_releve_legende ?> <?php echo $select_releve_pages_nb ?><br />
    <label class="tab">Modèle de document :</label><?php echo $select_releve_modele ?>
  </p>
  <p>
