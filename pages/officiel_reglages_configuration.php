...
<form action="#" method="post" id="form_bulletin">
  <p>
    ...
    &nbsp;&nbsp;&nbsp;<label for="f_bulletin_acquis_texte_nombre"><input type="checkbox" id="f_bulletin_acquis_texte_nombre" name="f_bulletin_acquis_texte_nombre" value="1"<?php echo $check_bulletin_acquis_texte_nombre ?> /> Indication du nombre d'items de chaque catégorie</label>
    &nbsp;&nbsp;&nbsp;<label for="f_bulletin_acquis_texte_code"><input type="checkbox" id="f_bulletin_acquis_texte_code" name="f_bulletin_acquis_texte_code" value="1"<?php echo $check_bulletin_acquis_texte_code ?> /> Indication des catégories</label><br />
