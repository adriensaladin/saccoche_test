...
<form action="#" method="post" id="form_select"><fieldset>
  ...
  <div class="toggle hide">
    ...
    <span class="tab"></span><label for="f_only_etat"><input type="checkbox" id="f_only_etat" name="f_only_etat" value="1"<?php echo $check_only_socle ?> /> Uniquement les items liés au socle</label><br />
