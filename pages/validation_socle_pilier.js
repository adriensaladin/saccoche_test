...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    (
      ...
      function()
      {
        ...
        {
          $('#ajax_msg_validation').attr('class','erreur').html('Pour annuler une validation, utiliser l\'interface dédiée.');
          return false;
        }
    ...
    (
      ...
      function()
      {
        ...
        if(classe_debut=='diag')
        {
          ...
          $(this).attr('class',new_classe_th).parent().parent().find('td').attr('class',new_classe_td);
          return false;
        }
      }
    );
