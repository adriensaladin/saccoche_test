...
if(!Outil::test_user_droit_specifique( $_SESSION['DROIT_ANNULATION_PILIER'] , NULL /*matiere_coord_or_groupe_pp_connu*/ , 0 /*matiere_id_or_groupe_id_a_tester*/ ))
{
  ...
  echo Outil::afficher_profils_droit_specifique($_SESSION['DROIT_ANNULATION_PILIER'],'li');
...
{
  if(Outil::test_droit_specifique_restreint($_SESSION['DROIT_ANNULATION_PILIER'],'ONLY_PP'))
  {
