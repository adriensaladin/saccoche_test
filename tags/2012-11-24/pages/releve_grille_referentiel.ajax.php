...
if( $type_generique || $type_individuel )
{
	...
	$legende_html = ($legende=='oui') ? Html::legende( TRUE /*codes_notation*/ , ($retroactif!='non') /*anciennete_notation*/ , ($colonne_bilan=='oui') /*etat_acquisition*/ , FALSE /*pourcentage_acquis*/ , FALSE /*etat_validation*/ ) : '' ;
	...
	foreach($tab_eleve as $tab)
	{
		...
		if($legende=='oui')
		{
			$releve_PDF->grille_referentiel_legende( TRUE /*codes_notation*/ , ($retroactif!='non') /*anciennete_notation*/ , ($colonne_bilan=='oui') /*etat_acquisition*/ );
