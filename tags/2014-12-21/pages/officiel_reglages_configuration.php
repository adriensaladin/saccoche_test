...
$select_releve_appreciation_rubrique_longueur = Form::afficher_select(Form::$tab_select_appreciation , 'f_releve_appreciation_rubrique_longueur' /*select_nom*/ , FALSE /*option_first*/ , $_SESSION['OFFICIEL']['RELEVE_APPRECIATION_RUBRIQUE_LONGUEUR'] /*selection*/ , '' /*optgroup*/);
$select_releve_appreciation_generale_longueur = Form::afficher_select(Form::$tab_select_appreciation , 'f_releve_appreciation_generale_longueur' /*select_nom*/ , FALSE /*option_first*/ , $_SESSION['OFFICIEL']['RELEVE_APPRECIATION_GENERALE_LONGUEUR'] /*selection*/ , '' /*optgroup*/);
...
$select_releve_fond                           = Form::afficher_select(Form::$tab_select_fond         , 'f_releve_fond'                           /*select_nom*/ , FALSE /*option_first*/ , $_SESSION['OFFICIEL']['RELEVE_FOND']                           /*selection*/ , '' /*optgroup*/);
...
$select_bulletin_appreciation_rubrique_longueur = Form::afficher_select(Form::$tab_select_appreciation , 'f_bulletin_appreciation_rubrique_longueur' /*select_nom*/ , FALSE /*option_first*/ , $_SESSION['OFFICIEL']['BULLETIN_APPRECIATION_RUBRIQUE_LONGUEUR'] /*selection*/ , '' /*optgroup*/);
$select_bulletin_appreciation_generale_longueur = Form::afficher_select(Form::$tab_select_appreciation , 'f_bulletin_appreciation_generale_longueur' /*select_nom*/ , FALSE /*option_first*/ , $_SESSION['OFFICIEL']['BULLETIN_APPRECIATION_GENERALE_LONGUEUR'] /*selection*/ , '' /*optgroup*/);
...
$select_bulletin_fond                           = Form::afficher_select(Form::$tab_select_fond         , 'f_bulletin_fond'                           /*select_nom*/ , FALSE /*option_first*/ , $_SESSION['OFFICIEL']['BULLETIN_FOND']                           /*selection*/ , '' /*optgroup*/);
...
$select_socle_appreciation_rubrique_longueur = Form::afficher_select(Form::$tab_select_appreciation , 'f_socle_appreciation_rubrique_longueur' /*select_nom*/ , FALSE /*option_first*/ , $_SESSION['OFFICIEL']['SOCLE_APPRECIATION_RUBRIQUE_LONGUEUR'] /*selection*/ , '' /*optgroup*/);
$select_socle_appreciation_generale_longueur = Form::afficher_select(Form::$tab_select_appreciation , 'f_socle_appreciation_generale_longueur' /*select_nom*/ , FALSE /*option_first*/ , $_SESSION['OFFICIEL']['SOCLE_APPRECIATION_GENERALE_LONGUEUR'] /*selection*/ , '' /*optgroup*/);
...
$select_socle_fond                           = Form::afficher_select(Form::$tab_select_fond         , 'f_socle_fond'                           /*select_nom*/ , FALSE /*option_first*/ , $_SESSION['OFFICIEL']['SOCLE_FOND']                           /*selection*/ , '' /*optgroup*/);
...
<form action="#" method="post" id="zone_matieres" class="hide">
  ...
  <?php echo Html::afficher_form_element_checkbox_matieres() ?>
