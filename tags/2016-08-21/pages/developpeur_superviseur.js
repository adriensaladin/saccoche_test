...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    (
      ...
      {
        $('#ajax_retour').html("");
        if( installation_type == 'multi-structures' )
        {
        ...
        (
          {
            ...
            data : 'csrf='+CSRF+'&f_base_id='+base_id+'&f_action='+action,
            dataType : 'json',
            ...
            success : function(responseJSON)
            {
              ...
              {
                $('#ajax_msg').attr('class','valide').html(responseJSON['label']);
                $('#ajax_retour').html(responseJSON['texte']);
              }
            }
          }
        );
