...
CREATE TABLE sacoche_livret_saisie (
  ...
  rubrique_type           VARCHAR(8)                                 COLLATE utf8_unicode_ci NOT NULL DEFAULT ""         COMMENT "eval | socle | ap | epi | parcours | viesco | bilan",
  rubrique_id             SMALLINT(5)                                UNSIGNED                NOT NULL DEFAULT 0          COMMENT "livret_rubrique_id | socle_composante (11;12;13;14;20;30;40;50) ; 0 pour viesco | bilan",
