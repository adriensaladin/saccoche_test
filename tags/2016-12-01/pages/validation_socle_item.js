        ...
        (
          {
            ...
            success : function(responseJSON)
            {
              ...
              if(responseJSON['statut']==true)
              {
                ...
                $('#f_pilier').html(responseJSON['value']).show();
                maj_domaine();
              }
              else
              {
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    var maj_domaine = function()
    {
      ...
      if(pilier_id)
      {
        $('#ajax_maj_domaine').attr('class','loader').html("En cours&hellip;");
        $.ajax
        (
          {
            type : 'POST',
            ...
            error : function(jqXHR, textStatus, errorThrown)
            {
              $('#ajax_maj_domaine').attr('class','alerte').html(afficher_json_message_erreur(jqXHR,textStatus));
            },
            success : function(responseJSON)
            {
              initialiser_compteur();
              if(responseJSON['statut']==true)
              {
                ...
                $('#f_domaine').html(responseJSON['value']).parent().show();
                if(navig_auto)
                {
                  navig_auto = false;
                  formulaire0.submit();
              ...
              {
                $('#ajax_maj_domaine').attr('class','alerte').html(responseJSON['value']);
              }
            }
          }
        );
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function retour_form_valide0(responseJSON)
    {
      ...
      else
      {
        ...
        responseJSON['value'] = responseJSON['value'].replace( '@PILIER@' , objet_option_pilier.text() );
        ...
        if(!objet_option_pilier.prev().length || !objet_option_pilier.prev().val()) { responseJSON['value'] = responseJSON['value'].replace( 'id="go_precedent_pilier"' , 'id="go_precedent_pilier" disabled' ); }
        if(!objet_option_pilier.next().length)                                      { responseJSON['value'] = responseJSON['value'].replace( 'id="go_suivant_pilier"'   , 'id="go_suivant_pilier" disabled'   ); }
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    (
      ...
      function()
      {
        ...
        $(this).attr('class',new_classe);
        if(modification==false)
        {
          $('#ajax_msg_validation').attr('class','alerte').html('Penser à valider les modifications !');
    ...
    (
      ...
      function()
      {
        ...
        if(classe_debut=='left')
        {
          ...
          $(this).attr('class',new_classe_th).parent().children('td').attr('class',new_classe_td);
          return false;
        }
        if(classe_debut=='down')
        {
          ...
          $(this).attr('class',new_classe_th).parent().parent().find('td[id^='+id+']').attr('class',new_classe_td);
          return false;
        }
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function maj_zone_information(last_id_survole)
    {
      ...
      $('#stats').html('');
      $('#items').html('');
      $('#ajax_msg_information').attr('class','loader').html("En cours&hellip;");
      $.ajax
      (
        {
          type : 'POST',
          ...
          error : function(jqXHR, textStatus, errorThrown)
          {
            $('#ajax_msg_information').attr('class','alerte').html(afficher_json_message_erreur(jqXHR,textStatus));
            return false;
          },
          success : function(responseJSON)
          {
            ...
            if(responseJSON['statut']==false)
            {
              $('#ajax_msg_information').attr('class','alerte').html(responseJSON['value']);
            }
            else
            {
        ...
        (
          {
            ...
            success : function(responseJSON)
            {
              ...
              {
                $('#ajax_msg_validation').attr('class','valide').html("Validations enregistrées !");
