...
$TITRE = html(Lang::_("Fusion de comptes"));
...
<p><span class="manuel"><a class="pop_up" href="<?php echo SERVEUR_DOCUMENTAIRE ?>?fichier=support_administrateur__gestion_eleves#toggle_fusionner_comptes">DOC : Fusionner deux comptes élèves</a></span></p>

<hr />

<form action="#" method="post" id="form_recherche">
  <h3>Compte élève actuel :</h3>
  <p>
