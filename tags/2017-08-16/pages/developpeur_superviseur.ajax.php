...
if($action=='ajouter')
{
  ...
  Json::add_row( 'texte' , '<li class="p">Login <b>'.$login.'</b> / Password <b>'.$password.'</b> / <a href="'.URL_DIR_SACOCHE.'?base='.$base_id.'&amp;mode=normal&amp;login='.$login.'" target="_blank" rel="noopener">Connexion.</a></li>' );
