...
$tab_serveur_cas['itslearning_caen']        = array( 'serveur_secure'=>  TRUE , 'serveur_host_subdomain'=>'fip'          , 'serveur_host_domain'=>'itslearning.com'                    , 'serveur_port'=> 443 , 'serveur_root'=>'SP/bn'                  , 'serveur_url_login'=>'' , 'serveur_url_logout'=>'' , 'serveur_url_validate'=>'' );
...
$tab_serveur_cas['netocentre_orleanstours'] = array( 'serveur_secure'=>  TRUE , 'serveur_host_subdomain'=>'lycees'       , 'serveur_host_domain'=>'netocentre.fr'                      , 'serveur_port'=> 443 , 'serveur_root'=>'cas'                    , 'serveur_url_login'=>'' , 'serveur_url_logout'=>'' , 'serveur_url_validate'=>'' );
...
// $tab_connexion_info['cas'][ '18|netocentre_orleanstours']    = array( 'txt'=>'ENT NetO\'Centre (lycées de l\'académie d\'Orléans-Tours).'   , 'etat'=>0 , 'societe'=>'GIP'                ) + $tab_csv_format['netocentre']           + $tab_serveur_cas['netocentre_orleanstours'];
...
// $tab_connexion_info['cas'][ '28|netocentre_orleanstours']    = array( 'txt'=>'ENT NetO\'Centre (lycées de l\'académie d\'Orléans-Tours).'   , 'etat'=>0 , 'societe'=>'GIP'                ) + $tab_csv_format['netocentre']           + $tab_serveur_cas['netocentre_orleanstours'];
...
// $tab_connexion_info['cas'][ '36|netocentre_orleanstours']    = array( 'txt'=>'ENT NetO\'Centre (lycées de l\'académie d\'Orléans-Tours).'   , 'etat'=>0 , 'societe'=>'GIP'                ) + $tab_csv_format['netocentre']           + $tab_serveur_cas['netocentre_orleanstours'];
// $tab_connexion_info['cas'][ '37|netocentre_orleanstours']    = array( 'txt'=>'ENT NetO\'Centre (lycées de l\'académie d\'Orléans-Tours).'   , 'etat'=>0 , 'societe'=>'GIP'                ) + $tab_csv_format['netocentre']           + $tab_serveur_cas['netocentre_orleanstours'];
...
// $tab_connexion_info['cas'][ '41|netocentre_orleanstours']    = array( 'txt'=>'ENT NetO\'Centre (lycées de l\'académie d\'Orléans-Tours).'   , 'etat'=>0 , 'societe'=>'GIP'                ) + $tab_csv_format['netocentre']           + $tab_serveur_cas['netocentre_orleanstours'];
...
// $tab_connexion_info['cas'][ '45|netocentre_orleanstours']    = array( 'txt'=>'ENT NetO\'Centre (lycées de l\'académie d\'Orléans-Tours).'   , 'etat'=>0 , 'societe'=>'GIP'                ) + $tab_csv_format['netocentre']           + $tab_serveur_cas['netocentre_orleanstours'];
...
$tab_connexion_info['cas'][ '50|itslearning_caen']           = array( 'txt'=>'ENT L’Educ de Normandie (académie de Caen).'                  , 'etat'=>1 , 'societe'=>'ItsLearning'        ) + $tab_csv_format['itslearning']          + $tab_serveur_cas['itslearning_caen'];
