...
CREATE TABLE sacoche_user (
  ...
  user_param_accueil  VARCHAR(83)  COLLATE utf8_unicode_ci NOT NULL DEFAULT "user,alert,messages,resultats,faiblesses,demandes,saisies,officiel,socle,help,ecolo",
