...
<div id="div_instance">
  ...
  <form action="#" method="post" id="form_chefetabl">
    ...
    <p class="astuce">
      Pour établir les bilans périodiques au collège et les positionnements de fin de cycle du <em>Livret Scolaire</em>, il est requis de désigner le chef d'établissement / directeur d'école.<br />
