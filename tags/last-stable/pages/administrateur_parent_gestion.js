...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function afficher_form_gestion( mode , id , id_ent , id_gepi , sconet_id , sconet_num , reference , profil , genre , nom , prenom , login , courriel , sortie_date_fr , check )
    {
    ...
    var ajouter = function()
    {
      ...
      afficher_form_gestion( mode , '' /*id*/ , '' /*id_ent*/ , '' /*id_gepi*/ , '' /*sconet_id*/ , '' /*sconet_num*/ , '' /*reference*/ , 'ENS' /*profil*/ , '' /*genre*/ , '' /*nom*/ , '' /*prenom*/ , '' /*login*/ , '' /*couriel*/ , '-' /*sortie_date_fr*/ , '' /*check*/ );
    };
    ...
    var modifier = function()
    {
      ...
      var check          = Number(objet_tds.eq(0).children('input').is(':checked'));
          td_resp        = objet_tds.eq( 1); // variable "globale"
      ...
      // Afficher le formulaire
      afficher_form_gestion( mode , id , unescapeHtml(id_ent) , unescapeHtml(id_gepi) , sconet_id , sconet_num , unescapeHtml(reference) , profil , unescapeHtml(genre) , unescapeHtml(nom) , unescapeHtml(prenom) , unescapeHtml(login) , unescapeHtml(courriel) , sortie_date_fr , check );
    };
      ...
      else
      {
        ...
        switch (mode)
        {
          ...
          case 'modifier':
            ...
            $('#id_'+$('#f_id').val()).addClass("new").html(responseJSON['value']).children('td:first-child').after(td_resp);
            break;
        }
        tableau_maj();
        $.fancybox.close();
