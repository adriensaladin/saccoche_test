...
if($base_id)
{
  ...
  else
  {
    ...
    Json::add_str(  '<li><a target="_blank" href="./force_download.php?fichier='.$fichier_export_nom.'.csv"><span class="file file_txt">Récupérer le fichier complet (format <em>csv</em>).</span></a></li>'.NL);
