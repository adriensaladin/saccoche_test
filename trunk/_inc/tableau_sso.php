...
$tab_connexion_info['cas']['ent_02']           = array( 'etat'=>1 , 'societe'=>'Infostance'         , 'serveur_host'=>'cas.scolastance.com'          , 'serveur_port'=>443  , 'serveur_root'=>'cas-ent02'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Aisne (département 02) sur Scolastance." );
$tab_connexion_info['cas']['ent_02_v2']        = array( 'etat'=>1 , 'societe'=>'ItsLearning'        , 'serveur_host'=>'cas.itslearning.com'          , 'serveur_port'=>443  , 'serveur_root'=>'cas-ent02'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Aisne (département 02) sur ItsLearning." );
$tab_connexion_info['cas']['ent_04']           = array( 'etat'=>1 , 'societe'=>'Infostance'         , 'serveur_host'=>'cas.cg04.fr'                  , 'serveur_port'=>443  , 'serveur_root'=>'cas-ent04'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Alpes de Haute-Provence (département 04) sur Scolastance." );
$tab_connexion_info['cas']['ent_04_v2']        = array( 'etat'=>1 , 'societe'=>'ItsLearning'        , 'serveur_host'=>'cas.itslearning.com'          , 'serveur_port'=>443  , 'serveur_root'=>'cas-ent04'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Alpes de Haute-Provence (département 04) sur ItsLearning." );
$tab_connexion_info['cas']['ent_06']           = array( 'etat'=>1 , 'societe'=>'iTOP'               , 'serveur_host'=>'cas.enteduc.fr'               , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Alpes-Maritimes (département 06)." ); // ITOP
$tab_connexion_info['cas']['ent_alsace']       = array( 'etat'=>1 , 'societe'=>'Infostance'         , 'serveur_host'=>'cas.scolastance.com'          , 'serveur_port'=>443  , 'serveur_root'=>'cas-alsace'     , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Alsace (académie de Strasbourg) sur Scolastance." );
// $tab_connexion_info['cas']['ent_alsace_v2']    = array( 'etat'=>1 , 'societe'=>'ItsLearning'        , 'serveur_host'=>'cas.itslearning.com'          , 'serveur_port'=>443  , 'serveur_root'=>'cas-alsace'     , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Alsace (académie de Strasbourg) sur ItsLearning." );
$tab_connexion_info['cas']['ent_95']           = array( 'etat'=>1 , 'societe'=>'iTOP'               , 'serveur_host'=>'ent95.valdoise.fr'            , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Anper95 (département du Val d'Oise 95)." ); // ENT95 (CG95)
...
$tab_connexion_info['cas']['ent_auvergne']     = array( 'etat'=>1 , 'societe'=>'Infostance'         , 'serveur_host'=>'cas.scolastance.com'          , 'serveur_port'=>443  , 'serveur_root'=>'cas-auvergne'   , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Auvergne (académie de Clermond-Ferrand) sur Scolastance." );
// $tab_connexion_info['cas']['ent_auvergne_v2']  = array( 'etat'=>1 , 'societe'=>'ItsLearning'        , 'serveur_host'=>'cas.itslearning.com'          , 'serveur_port'=>443  , 'serveur_root'=>'cas-auvergne'   , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Auvergne (académie de Clermond-Ferrand) sur ItsLearning." );
...
$tab_connexion_info['cas']['ent_27']           = array( 'etat'=>1 , 'societe'=>'iTOP'               , 'serveur_host'=>'cas.enteduc.fr'               , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Eure (département 27)." ); // ITOP
$tab_connexion_info['cas']['ent_52']           = array( 'etat'=>1 , 'societe'=>'Infostance'         , 'serveur_host'=>'cas.scolastance.com'          , 'serveur_port'=>443  , 'serveur_root'=>'cas-hautemarne' , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Haute-Marne (département 52) sur Scolastance." );
$tab_connexion_info['cas']['ent_52_v2']        = array( 'etat'=>1 , 'societe'=>'ItsLearning'        , 'serveur_host'=>'cas.itslearning.com'          , 'serveur_port'=>443  , 'serveur_root'=>'cas-hautemarne' , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Haute-Marne (département 52) sur ItsLearning." );
$tab_connexion_info['cas']['ent_92']           = array( 'etat'=>1 , 'societe'=>'iTOP'               , 'serveur_host'=>'www.enc92.fr'                 , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Hauts-de-Seine (collèges département 92)." ); // ENC92 (CG92)
$tab_connexion_info['cas']['ent_38']           = array( 'etat'=>1 , 'societe'=>'iTOP'               , 'serveur_host'=>'cas.enteduc.fr'               , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Isère (département 38)." ); // ITOP
...
$tab_connexion_info['cas']['mirabelle']        = array( 'etat'=>1 , 'societe'=>'iTOP'               , 'serveur_host'=>'www.ent-place.fr'             , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Mirabelle (département Moselle 57)." ); // PLACE (Place et Mirabelle, Alsace Lorraine)
$tab_connexion_info['cas']['ent_60']           = array( 'etat'=>1 , 'societe'=>'iTOP'               , 'serveur_host'=>'ent.oise.fr'                  , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Oise (département 60)." ); // ENT60 (CG60)
$tab_connexion_info['cas']['place']            = array( 'etat'=>1 , 'societe'=>'iTOP'               , 'serveur_host'=>'www.ent-place.fr'             , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Place (Lorraine - départements 54 55)." ); // PLACE (Place et Mirabelle, Alsace Lorraine)
...
$tab_connexion_info['cas']['ent_lille']        = array( 'etat'=>1 , 'societe'=>'iTOP'               , 'serveur_host'=>'www.savoirsnumeriques5962.fr' , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Savoirs numériques 5962 (académie de Lille)." ); // SN5962 (CG59+CG62)
...
$tab_connexion_info['cas']['ent_80']           = array( 'etat'=>1 , 'societe'=>'iTOP'               , 'serveur_host'=>'cas.enteduc.fr'               , 'serveur_port'=>443  , 'serveur_root'=>'cas'            , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>1 , 'csv_prenom'=>2 , 'csv_id_ent'=>0 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Somme (département 80)." ); // ITOP
$tab_connexion_info['cas']['ent_90']           = array( 'etat'=>1 , 'societe'=>'Infostance'         , 'serveur_host'=>'cas.scolastance.com'          , 'serveur_port'=>443  , 'serveur_root'=>'cas-ent90'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Territoire de Belfort (département 90) sur Scolastance." );
// $tab_connexion_info['cas']['ent_90_v2']        = array( 'etat'=>1 , 'societe'=>'ItsLearning'        , 'serveur_host'=>'cas.itslearning.com'          , 'serveur_port'=>443  , 'serveur_root'=>'cas-ent90'      , 'csv_infos'=>TRUE  , 'csv_entete'=>1 , 'csv_nom'=>2 , 'csv_prenom'=>3 , 'csv_id_ent'=>4 , 'csv_id_sconet'=>NULL , 'txt'=>"ENT Territoire de Belfort (département 90) sur ItsLearning." );
