...
public static function DB_lister_jointure_groupe_periode($listing_groupes_id)
{
  ...
  {
    ajouter_log_PHP( 'Erreur DB_lister_jointure_groupe_periode()' /*log_objet*/ , $listing_groupes_id /*log_contenu*/ , __FILE__ /*log_fichier*/ , __LINE__ /*log_ligne*/ , TRUE /*only_sesamath*/ );
  }
