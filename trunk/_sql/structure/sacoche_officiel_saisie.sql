...
-- rubrique_id>0 + prof_id=0 = note rubrique (bulletin)
...
CREATE TABLE sacoche_officiel_saisie (
	...
	prof_id             MEDIUMINT(8)                                            UNSIGNED                NOT NULL DEFAULT 0    COMMENT "0 pour la note, avec commentaire dans saisie_appreciation si report non automatique",
