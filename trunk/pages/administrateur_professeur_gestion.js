...
// ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function afficher_form_gestion( mode , id , id_ent , id_gepi , sconet_id , reference , profil , nom , prenom , login , courriel , date_fr , check )
    {
      ...
      {
        $('#box_date').prop('checked',false).next().css('display','none'); // plutôt que .hide(0) car suite au passage vers jQuery 1.10.2 un hide() sur un élément déjà caché provoque ici sa réapparition...
